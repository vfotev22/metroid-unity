/* A component controlling the behavior of the Aesthetic aspect of IT487FunBall */
 ...
 * 
 * For example, the 487FunBall appears to get temporarily larger when the player touches it.
 ...
 * To prevent this, In our current setup, the 487FunBall never actually resizes, but the object representing it
...
public class IT487FunBallAesthetics : MonoBehaviour {

    /* Inspector Tunables */
    public IT487FunBallController target;
    ...
    void Start() {
        ...
        if (target != null)
            ...
            Debug.LogError("target of IT487FunBallAesthetic has yet to be defined in the inspector");
